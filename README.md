...
| Model (Cityscapes) | Val (% mIOU) | Test (% mIOU)| FPS (RTX 3090) | FPS (i7-10875H) | FPS (Xavier&TensorRT) |
|:-:|:-:|:-:|:-:|:-:|:-:|
| SANet-50 |  73.7 | 72.7 | 309.7 | x | pending | 
| SANet-75 | 77.6  | 76.6 | 167.3 | x | pending | 
| SANet-100 | 79.1 | 78.1 | 109.0 | x | pending | 
